...
from paymentapp.views import CheckoutView, PaymentSuccessView, PayForCheckoutView, PaymentListView, PaymentRefundView
urlpatterns=[
    ...
    path('checkout/<int:user_id>', CheckoutView.as_view(), name='checkoutS'),
