...
SECRET_KEY = 'django-insecure-6$#(^4$+9kplnx_e$x42#93!+5*5w7dh_#!fpc9t(k=81b_b_*'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']  # Adjust this to your production domain
...
AUTH_USER_MODEL='accounted.User'
...
EMAIL_HOST_PASSWORD ="mgpy xfmn soci tnoi"
EMAIL_USE_TLS = True
# JWT Settings
SIMPLE_JWT = {
...
# from ecommerce.settings import PASSWORD_RESET_TIMEOUT
